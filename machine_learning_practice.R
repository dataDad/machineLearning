...
# Replace missing embarked values with mode. This is called imputation.
...
#most features make accuracy worst....if it's getting better, that means you're doing it right. 60% of a data
#scientist job is data management. Cleaning, absorbing, understanding, loading
...
# First, transform all feature to dummy variables. need to convert factors to numerics
